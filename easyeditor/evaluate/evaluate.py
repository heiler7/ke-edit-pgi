...
def compute_edit_quality(
    ...
    ret['locality'] = {}
    ret['portability'] = {}
    if rephrase_prompts is not None and rephrase_prompts != '':
        ret.update(
    ...
    **kwargs,
    ...
    if hasattr(hparams, 'evaluation_type') and hparams.evaluation_type == "LLM-judge":
        ...
        if 't5' in model_name.lower():
            ...
            if portability_key == 'single_hop':
                portability_correct = test_prediction_acc(model, tok, hparams, prompt, ground_truth, device, vanilla_generation=True,pkey=portability_key)
            else:
