            ...
            data.append(
                {
                    ...
                    "rewrite": record["rephrase_prompt"] if "rephrase_prompt" in record else record["rephrase"] if "rephrase" in record else None,
                    ...
                    "portability_m":record["portability"]["multihop"] if "portability" in record and "multihop" in record["portability"] else None,
                    "portability_h":record["portability"]["single_hop"] if "portability" in record and "single_hop" in record["portability"] else None,
                    ...
                    "context": record["context"] if "context" in record else None,
                    "rephrase_example": record["rephrase_example"] if "rephrase_example" in record else None,
                }
            )
        pre = 0
        if size is not None:
            data = data[pre:pre+size]
        self._data = data
